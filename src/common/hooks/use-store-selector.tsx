...
/**
 * @description A custom hook to select state from a Zustand store within a React context.
 ...
 */
export const useStoreSelector = <T extends { [K in keyof T]: any }>(context: React.Context<StoreApi<T>>) => {
