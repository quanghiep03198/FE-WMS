...
const featuresLayoutDashboardIndexLazyImport = createFileRoute('/(features)/_layout/dashboard/')();
...
const featuresLayoutDashboardIndexLazyRoute = featuresLayoutDashboardIndexLazyImport
	.update({
		path: '/dashboard/',
		getParentRoute: () => featuresLayoutRoute
	} as any)
	.lazy(() => import('./app/(features)/_layout.dashboard/index.lazy').then((d) => d.Route));
