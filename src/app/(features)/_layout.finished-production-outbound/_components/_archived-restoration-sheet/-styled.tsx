...
export const SheetBody = tw.div`flex flex-col flex-1 gap-y-6 w-full`
export const ListContainer = tw.div`space-y-2`
export const ListHeader = tw.div`grid grid-cols-[24px_auto_24px] mr-[10px] [&>:first-child]:place-self-center [&>:last-child]:place-self-center items-center gap-x-6 px-2 py-4 border-b`
export const ListItem = tw.label`grid grid-cols-[24px_auto_24px] [&>:first-child]:place-self-center [&>:last-child]:place-self-center items-center gap-x-6 p-2 cursor-pointer hover:bg-accent/50 hover:text-accent-foreground inset-x-0 rounded-md font-medium aria-selected:bg-accent`
