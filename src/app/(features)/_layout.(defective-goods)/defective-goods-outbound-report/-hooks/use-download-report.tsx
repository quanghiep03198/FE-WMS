...
export const useDownloadReport = () => {
	...
	return useMemoizedFn(async () => {
		...
		try {
			const blob = await DefectiveGoodsService.downloadOutboundReport(currentTenant?.id, searchParams)
			saveAs(
				blob,
				t('ns_inoutbound:titles.daily_defective_gooods_outbound_report', {
