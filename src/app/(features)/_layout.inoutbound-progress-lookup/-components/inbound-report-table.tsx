...
import InboundReportDetailTable from '../../_layout.inbound-report/-components/report-detail-table'
import { ChartPieDonutActive } from './order-status-card'
								...
								<TableRow>
									<TableCell colSpan={7} className='bg-accent/25 p-6'>
										<Div className='flex items-stretch gap-x-6'>
											<InboundReportDetailTable data={item.size_data} />
											<ChartPieDonutActive />
										</Div>
									</TableCell>
								</TableRow>
