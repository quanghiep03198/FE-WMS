...
const CounterPanel = tw.div`relative xl:col-span-1 xl:row-span-1 flex flex-col items-center justify-center gap-y-3 rounded-[var(--radius)] border text-center xl:order-2 order-1`
