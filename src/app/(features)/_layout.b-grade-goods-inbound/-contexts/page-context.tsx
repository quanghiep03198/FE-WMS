...
const PageContext = createContext<{ event$: EventEmitter<{ action: CommonActions; payload: IDefectiveGoods }> }>(null)

export const PageContextProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
	const event$ = useEventEmitter<{ action: CommonActions; payload: IDefectiveGoods }>()
