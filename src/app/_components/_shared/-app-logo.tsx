...
const AppLogo: React.FC = () => {
	return (
		<Div className='flex items-center gap-x-3 font-jetbrains group-data-[state=expanded]:gap-x-3 xl:gap-x-0'>
			<Div className='flex aspect-square flex-col items-stretch justify-center gap-y-2 rounded bg-primary p-2 text-center font-jetbrains text-[10px] text-sm font-medium leading-none tracking-widest text-primary-foreground shadow-2xl group-data-[state=collapsed]:size-8 group-data-[state=expanded]:size-12 group-data-[state=collapsed]:gap-y-1.5 group-data-[state=collapsed]:p-[3px] group-data-[state=collapsed]:text-[10px]'>
				WMS
