...
const GridDotBackground: React.FC = () => {
	return (
		<Div className='absolute left-1/2 top-1/2 z-0 mx-auto h-[50vh] w-full max-w-[45vw] -translate-x-1/2 -translate-y-1/2 skew-y-18 scale-110 transition-transform duration-500 ease-in-out xxl:scale-110'>
			<Div className='pointer-events-none absolute inset-0 z-10 flex items-center justify-center bg-background text-foreground mask-[radial-gradient(circle_at_center,transparent_10%,black)]' />
			<Div
				className={cn(
					'absolute inset-0',
					'bg-size-[40px_40px]',
