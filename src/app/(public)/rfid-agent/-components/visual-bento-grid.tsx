...
const VisualBentoGrid: React.FC = () => {
	return (
		<Div className='mx-auto grid w-full max-w-8xl grid-cols-6 gap-4 overflow-hidden p-2 py-20 @container/visual sm:grid-cols-1 lg:grid-flow-row lg:p-6 xl:grid-flow-row xl:p-6'>
			<Div className='col-span-full sm:col-span-full md:col-span-3 lg:order-2 lg:col-span-3 xl:col-span-2 xl:row-span-2'>
				<MQTTVisualCard />
			</Div>
			<Div className='order-first col-span-full xl:order-2 xl:col-span-2 xl:row-span-1'>
				<OSVisualCard />
			</Div>
			<Div className='col-span-full sm:col-span-full md:col-span-3 lg:col-span-3 xl:order-2 xl:col-span-2 xl:row-span-1'>
				<RealtimeVisualCard />
			</Div>
