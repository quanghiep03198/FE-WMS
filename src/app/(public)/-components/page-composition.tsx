...
const Wrapper = tw.div`relative z-0 py-20 first:py-10 xxl:min-h-[85vh] xl:min-h-[75vh] xl:px-0 sm:py-4 sm:px-4 px-6 sm:mb-10 flex flex-grow justify-center items-stretch`
