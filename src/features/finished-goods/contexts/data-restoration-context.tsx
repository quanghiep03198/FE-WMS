...
const DataRestorationContext = createContext<StoreApi<DataRestorationFilterStore>>(null)
...
export const DataRestorationProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
	...
	return <DataRestorationContext.Provider value={store.current}>{children}</DataRestorationContext.Provider>
}

export const useDataRestorationContext = createStoreSelector(DataRestorationContext)
