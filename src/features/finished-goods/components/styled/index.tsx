...
export const ListHeader = tw.div`grid grid-cols-[10%_50%_20%_20%] mr-2.5 *:first:place-self-center *:last:place-self-center items-center gap-x-2 px-2 py-4 border-b`
...
export const ListBody = tw.div`xxl:h-[50vh] h-[40vh] space-y-1 scroll-auto! scroll-fade`
