	...
	return (
		<>
			...
			<div
				...
				<header className='paused group-aria-current/cta:running z-0 col-start-2 mb-4 animate-[fly-down_0.7s_ease_forwards] p-4'>
				...
				<main className='z-0 col-start-2 h-fit space-y-6 p-4 pt-0'>
					<div className='paused group-aria-current/cta:running animate-[fly-down_0.7s_ease_forwards] space-y-1'>
						<h1 className='text-xl font-semibold'>Dashboard</h1>
						<small className='text-muted-foreground line-clamp-1 leading-none'>
					...
					<section className='flex items-stretch gap-x-4 [&>*[data-slot=card]]:min-w-72'>
						<Card className='paused group-aria-current/cta:running animate-[fly-down_0.8s_ease-in-out_forwards]'>
							<CardHeader>
						...
						<Card className='paused group-aria-current/cta:running animate-[fly-down_0.9s_ease-in-out_forwards]'>
							<CardHeader>
					...
					<section>
						<Card
							data-role='card'
							className='paused group-aria-current/cta:running min-w-128 animate-[fly-down_1s_ease-in-out_forwards]'>
							<CardHeader>
