...
import { TRANSLATED_DEFECTIVE_CATEGORY } from '../../constants/enums'
import { useDefectiveCategoryList } from '../../hooks/use-defective-category-list'
import { useGetDefectiveGoodsInventoryQuery } from '../../hooks/use-defective-goods-request'
...
import type { IDefectiveGoodsInventory } from '../../types'
