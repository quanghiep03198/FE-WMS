...
const InputTagTrigger = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
...
InputTagTrigger.displayName = 'MultiSelectTrigger'

const InputTagSelectInput: React.FC<React.ComponentProps<typeof CommandPrimitive.Input>> = ({
	className,
	...props
}) => {
	const {
...
InputTagSelectInput.displayName = 'InputTagSelectInput'

const InputTagSelectContent: React.FC<React.ComponentProps<'div'>> = ({ children, ref }) => {
...
InputTagSelectContent.displayName = 'InputTagSelectContent'

const InputTagSelectList: React.FC<React.ComponentProps<typeof CommandPrimitive.List>> = ({
	className,
	ref,
	children
}) => {
...
InputTagSelectList.displayName = 'MultiSelectList'

const InputTagSelectItem = forwardRef<
