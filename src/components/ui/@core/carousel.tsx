...
const CarouselPrevious: React.FC<ButtonProps> = ({ className, variant = 'outline', size = 'icon', ...props }) => {
...
const CarouselNext: React.FC<ButtonProps> = ({ className, variant = 'outline', size = 'icon', ...props }) => {
